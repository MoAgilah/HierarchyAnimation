...
struct Vertex_Pos3fColour4ub
{
	...
	Vertex_Pos3fColour4ub(const D3DXVECTOR3 &pos, VertexColour colour);
};
...
struct Vertex_Pos3fColour4ubTex2f
{
	...
	Vertex_Pos3fColour4ubTex2f(const D3DXVECTOR3 &pos, VertexColour colour, const D3DXVECTOR2 &tex);
};
...
public:
	...
	void EnableDirectionalLight(int light, const D3DXVECTOR3 &worldDirection, const D3DXVECTOR3 &diffuseColour);
	void EnablePointLight(int light, const XMFLOAT3 &worldPosition, const XMFLOAT3 &diffuseColour);
	void EnableSpotLight(int light, const D3DXVECTOR3 &worldPosition, const D3DXVECTOR3 &worldDirection, float theta, float phi, float falloff, const D3DXVECTOR3 &diffuseColour);
