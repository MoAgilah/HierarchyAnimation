...
Vertex_Pos3fColour4ub::Vertex_Pos3fColour4ub(const D3DXVECTOR3 &posArg, VertexColour colourArg):
pos(posArg),
colour(colourArg)
{
}
...
Vertex_Pos3fColour4ubTex2f::Vertex_Pos3fColour4ubTex2f(const D3DXVECTOR3 &posArg, VertexColour colourArg, const D3DXVECTOR2 &texArg):
pos(posArg),
colour(colourArg),
tex(texArg)
{
...
Vertex_Pos3fColour4ubNormal3fTex2f::Vertex_Pos3fColour4ubNormal3fTex2f(const D3DXVECTOR3 &posArg, VertexColour colourArg, const D3DXVECTOR3 &normalArg, const D3DXVECTOR2 &texArg):
pos(posArg),
colour(colourArg),
normal(normalArg),
tex(texArg)
...
void CommonApp::EnableDirectionalLight(int light, const D3DXVECTOR3 &worldDirection, const D3DXVECTOR3 &diffuseColour)
{
	if (Light *pLight = this->GetLight(light))
	{
		pLight->type = Light::Type_Directional;

		D3DXVec3Normalize(&pLight->direction, &worldDirection);
		...
		pLight->diffuseColour = diffuseColour;
	}
}
...
void CommonApp::EnableSpotLight(int light, const D3DXVECTOR3 &worldPosition, const D3DXVECTOR3 &worldDirection, float theta, float phi, float falloff, const D3DXVECTOR3 &diffuseColour)
{
	if (Light *pLight = this->GetLight(light))
	{
